...
- Live upload writes and rename behavior still depend on the pending Cloudflare storage/binding setup; this repo change only keeps the published asset tree ready for that path.
